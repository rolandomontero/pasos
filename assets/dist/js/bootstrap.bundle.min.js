...
window.addEventListener("scroll", logoEscalar);
window.addEventListener("resize", logoEscalar);
...
function logoEscalar() {
    let f = 180;
    var ancho = this.innerWidth;
    var element = document.querySelector('.bg-light');
    var gotop = document.querySelector('.circle');
    var logo = document.querySelector('.navbar-brand img');
    element.style.setProperty('--bs-bg-opacity', ((window.scrollY / f) < 0.98) ? window.scrollY / f : (window.scrollY < 400) ? 0.98 : 1);
    logo.style.setProperty('opacity', ((window.scrollY / f) < 0.99998 && ancho > 1200) ? window.scrollY / (3 * f) : (window.scrollY < 420) ? 0.98 : 1);
    logo.style.visibility = (scrollY < 70 && ancho > 1200) ? 'hidden' : 'visible';
    gotop.style.visibility = (scrollY < 400) ? 'hidden' : 'visible';
    console.log('ScrollY :' + window.scrollY + ' ancho:' + ancho + ' Opacity: ' + (window.scrollY / (3 * f)));
}