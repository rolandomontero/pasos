...
function logoEscalar() {
    ...
    logo.style.setProperty('--bs-bg-opacity', (scrollY < 100 && ancho > 1200) ? window.scrollY / f : (window.scrollY < 400) ? 0.98 : 1);
    logo.style.visibility = (scrollY < 124 && ancho > 1200) ? 'hidden' : 'visible';
    console.log('ScrollY :' + window.scrollY + ' ancho:' + ancho);
